...
(function(d) {
    ...
    }) : "object" === typeof exports ? module.exports = function(m, l) {
        m || (m = window);
    ...
    d.extend(i.prototype, {
        ...
        _columnsVisiblity: function(a) {
            var b = this.s.dt,
                ...
                j = d.map(c, function(c, e) {
                    return !1 === b.column(e).visible() ? "not-visible" : c.auto && null === c.minWidth ? !1 : !0 === c.auto ? "-" : -1 !== d.inArray(a, c.includeIn)
                }),
                h = 0;
            e = 0;
            ...
            return d.map(this.s.columns, function(e, f) {
                if (!e.never && !e.control) {
                    ...
                    return {
                        ...
                        rowIndex: a,
                        title: null !== g.sTitle ? g.sTitle : d(c.column(f).header()).text()
                    }
                }
            })
        },
        ...
        _resize: function(a) {
            ...
            for (e = j.length; h < e; h++)
                if (!1 === k[h] && !j[h].never && !j[h].control && !1 === !c.column(h).visible()) {
                    f = !0;
                    break
        ...
        _resizeAuto: function() {
            ...
            if (this.c.auto && -1 !== d.inArray(!0, d.map(b, function(a) {
                ...
                c.style.width = "auto";
                var g = a.columns().header().filter(function(b) {
                ...
                if (f = a.table().footer()) {
                    var f = d(f.cloneNode(!1)).appendTo(c),
                        j = a.columns().footer().filter(function(b) {
                            return a.column(b).visible()
        ...
        listHiddenNodes: function() {
            return function(a, b, c) {
                ...
                d.each(c, function(b, c) {
                    c.hidden && (d("<li " + (c.className ? 'class="' + c.className + '"' : "") + ' data-dtr-index="' + c.columnIndex + '" data-dt-row="' + c.rowIndex + '" data-dt-column="' + c.columnIndex + '"><span class="dtr-title">' + c.title + "</span> </li>").append(d('<span class="dtr-data"/>').append(t(a, c.rowIndex, c.columnIndex))).appendTo(e), f = !0)
                });
                return f ? e : !1
            }
        },
